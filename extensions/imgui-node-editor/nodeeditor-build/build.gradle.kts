...
jParser {
    libName.set("nodeeditor")
    modulePrefix.set("nodeeditor")
    modulePath(file(".."))
    moduleCSuffix.set("c")
    packageName.set("imgui.extension.nodeeditor")
    cppSourcePath(nodeEditorSourceDir)
    jniCppStandard.set("c++17")
    ffmCppStandard.set("c++17")
    webCppStandard.set("c++17")
    teaVMCCppStandard.set("c++17")
    webForcedInclude(file("src/main/cpp/custom/NodeEditorWebIncludes.h"))
    ...
    native {
        ...
        cppInclude("${nodeEditorSourceDir.normalizedPath()}/*.cpp")
        cppExclude("${nodeEditorSourceDir.normalizedPath()}/examples/**/*.cpp")
        cppExclude("${nodeEditorSourceDir.normalizedPath()}/external/**/*.cpp")

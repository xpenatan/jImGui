...
public final class BuildTextEdit {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File sourceDir = new File(projectDir, "build/ImGuiColorTextEdit");
        File regexInclude = new File(sourceDir, "vendor/regex/include");
        ...
        config.webForcedInclude = path(new File(projectDir, "src/main/cpp/custom/TextEditWebIncludes.h"));
        config.globalHooks.headerDirs.add(path(imguiSource));
        config.globalHooks.headerDirs.add(path(imguiCustom));
        config.globalHooks.headerDirs.add(path(sourceDir));
        config.globalHooks.headerDirs.add(path(regexInclude));
        addTextEditSources(config, sourceDir);
    ...
    private static BuildToolOptions.BuildToolParams params(File moduleRoot, File sourceDir) {
        ...
        params.libName = "textedit";
        params.idlName = "ColorTextEdit";
        params.webModuleName = "textedit";
        params.packageName = "imgui.extension.textedit";
        params.cppSourcePath = path(sourceDir);
        params.modulePath = path(moduleRoot);
        params.modulePrefix = "textedit";
    ...
    private static void addTextEditSources(DefaultBuildTargetConfig config, File sourceDir) {
        String root = path(sourceDir);
        config.globalHooks.cppIncludes.add(root + "/ImGuiDebugPanel.cpp");
        config.globalHooks.cppIncludes.add(root + "/LanguageDefinitions.cpp");
        config.globalHooks.cppIncludes.add(root + "/TextEditor.cpp");
        config.globalHooks.cppIncludes.add(root + "/UnitTests.cpp");
        config.globalHooks.cppIncludes.add(root + "/vendor/regex/src/*.cpp");
        config.globalHooks.cppExcludes.add(root + "/vendor/regex/build/**/*.cpp");
        config.globalHooks.cppExcludes.add(root + "/vendor/regex/example/**/*.cpp");
        config.globalHooks.cppExcludes.add(root + "/vendor/regex/performance/**/*.cpp");
        config.globalHooks.cppExcludes.add(root + "/vendor/regex/test/**/*.cpp");
        config.globalHooks.cppExcludes.add(root + "/vendor/regex/tools/**/*.cpp");
        config.globalHooks.compileFlags.add("-includecmath");
    }

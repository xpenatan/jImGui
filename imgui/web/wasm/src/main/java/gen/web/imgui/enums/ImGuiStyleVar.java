...
public enum ImGuiStyleVar implements NativeEnum<ImGuiStyleVar> {
    ...
    @org.teavm.jso.JSBody(script = "return imgui.ImGuiStyleVar_ImageRounding;")
    ...
    @org.teavm.jso.JSBody(script = "return imgui.ImGuiStyleVar_MenuItemRounding;")
    private static native int ImGuiStyleVar_MenuItemRounding_NATIVE();

    @org.teavm.jso.JSBody(script = "return imgui.ImGuiStyleVar_SelectableRounding;")
    private static native int ImGuiStyleVar_SelectableRounding_NATIVE();

    @org.teavm.jso.JSBody(script = "return imgui.ImGuiStyleVar_DragDropTargetRounding;")
    ...
    @org.teavm.jso.JSBody(script = "return imgui.ImGuiStyleVar_SeparatorSize;")

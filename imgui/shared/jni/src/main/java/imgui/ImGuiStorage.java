...
public final class ImGuiStorage extends NativeObject {
    ...
    public static long internal_native_GetIntRef_addr(long this_addr, int key, int default_val) {
        return imgui.natives.JNI_ImGuiStorage.internal_native_GetIntRef_addr(this_addr, key, default_val);
    }
    ...
    public static long internal_native_GetIntRef_addr(long this_addr, int key) {
        return imgui.natives.JNI_ImGuiStorage.internal_native_GetIntRef_addr(this_addr, key);
    }
    ...
    public static long internal_native_GetBoolRef_addr(long this_addr, int key, boolean default_val) {
        return imgui.natives.JNI_ImGuiStorage.internal_native_GetBoolRef_addr(this_addr, key, default_val);
    }
    ...
    public static long internal_native_GetBoolRef_addr(long this_addr, int key) {
        return imgui.natives.JNI_ImGuiStorage.internal_native_GetBoolRef_addr(this_addr, key);
    }
    ...
    public static long internal_native_GetFloatRef_addr(long this_addr, int key, float default_val) {
        return imgui.natives.JNI_ImGuiStorage.internal_native_GetFloatRef_addr(this_addr, key, default_val);
    }
    ...
    public static long internal_native_GetFloatRef_addr(long this_addr, int key) {
        return imgui.natives.JNI_ImGuiStorage.internal_native_GetFloatRef_addr(this_addr, key);
    }
    ...
    public static long internal_native_GetVoidPtrRef_addr(long this_addr, int key, long default_val_addr) {
        return imgui.natives.JNI_ImGuiStorage.internal_native_GetVoidPtrRef_addr(this_addr, key, default_val_addr);
    }
    ...
    public static long internal_native_GetVoidPtrRef_addr(long this_addr, int key) {
        return imgui.natives.JNI_ImGuiStorage.internal_native_GetVoidPtrRef_addr(this_addr, key);
    }
    ...
    public static void internal_native_BuildSortByKey(long this_addr) {
        imgui.natives.JNI_ImGuiStorage.internal_native_BuildSortByKey(this_addr);
    }

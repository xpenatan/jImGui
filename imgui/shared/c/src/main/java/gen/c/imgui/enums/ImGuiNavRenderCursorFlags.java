...
public enum ImGuiNavRenderCursorFlags implements NativeEnum<ImGuiNavRenderCursorFlags> {
    ...
    @org.teavm.interop.Import(name = "imgui_enums_imguinavrendercursorflags_imguinavrendercursorflags_none_native")
    private static native int ImGuiNavRenderCursorFlags_None_NATIVE();

    @org.teavm.interop.Import(name = "imgui_enums_imguinavrendercursorflags_imguinavrendercursorflags_compact_native")

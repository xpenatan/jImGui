...
public enum ImGuiDockNodeState implements NativeEnum<ImGuiDockNodeState> {
    ...
    @org.teavm.interop.Import(name = "imgui_enums_imguidocknodestate_imguidocknodestate_unknown_native")
    private static native int ImGuiDockNodeState_Unknown_NATIVE();

    @org.teavm.interop.Import(name = "imgui_enums_imguidocknodestate_imguidocknodestate_hostwindowhiddenbecausesinglewindow_native")
    private static native int ImGuiDockNodeState_HostWindowHiddenBecauseSingleWindow_NATIVE();

    @org.teavm.interop.Import(name = "imgui_enums_imguidocknodestate_imguidocknodestate_hostwindowhiddenbecausewindowsareresizing_native")
    private static native int ImGuiDockNodeState_HostWindowHiddenBecauseWindowsAreResizing_NATIVE();

    @org.teavm.interop.Import(name = "imgui_enums_imguidocknodestate_imguidocknodestate_hostwindowvisible_native")
